...
export const ReportModal: React.FC<ReportModalProps> = ({
  ...
  const handleExportCSV = () => {
    ...
    const rows = getReportRows();
    exportToCsvBlob({
      filename: `commission_report_${selectedReportDate}_${Date.now()}.csv`,
      headers: headersList,
      rows,
    });
  };
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800 mb-3 shrink-0 gap-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            >
              ...
              <span className="hidden sm:inline">PDF & Share</span>
            ...
            <button
              ...
              className="px-2 py-1.5 sm:px-2.5 sm:py-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 dark:bg-emerald-950/60 dark:text-emerald-300 dark:hover:bg-emerald-900/60 border border-emerald-200 dark:border-emerald-800 rounded-lg text-xs font-bold transition-colors cursor-pointer flex items-center gap-1"
              title="Excel (.xlsx) ဒေါင်းလုဒ် / Save As"
            >
            ...
            <button
              ...
              className="px-2 py-1.5 sm:px-2.5 sm:py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 dark:bg-indigo-950/60 dark:text-indigo-300 dark:hover:bg-indigo-900/60 border border-indigo-200 dark:border-indigo-800 rounded-lg text-xs font-bold transition-colors cursor-pointer flex items-center gap-1"
            ...
            <button
              onClick={handlePrint}
              className="px-2 py-1.5 sm:px-2.5 sm:py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-200 rounded-lg text-xs font-bold transition-colors cursor-pointer flex items-center gap-1"
                ...
                <table className="w-full text-xs text-left border-collapse min-w-[880px]">
                  <thead className="bg-slate-100 dark:bg-slate-800 sticky top-0 z-20 text-slate-700 dark:text-slate-200 font-bold border-b border-slate-200 dark:border-slate-700 shadow-2xs">
                    <tr className="min-h-[52px]">
                      ...
                      <th className="px-2.5 py-3.5 min-w-[125px]">
                        <div className="flex flex-col break-words leading-snug">
                          <span>ဖောက်သည် အမည်</span>
                          <span className="text-[10px] font-normal text-slate-500">(Customer)</span>
                        </div>
                      </th>
                      <th className="px-2 py-3.5 text-center whitespace-nowrap min-w-[75px]">
                      ...
                      <th className="px-2.5 py-3.5 text-right whitespace-nowrap w-px bg-amber-50/70 dark:bg-amber-950/40 text-amber-900 dark:text-amber-200 font-mono">
                        <div className="flex flex-col items-end leading-snug">
                          <span>ငွေသားကော်မရှင်</span>
                          <span className="text-[10px] font-normal text-amber-700 dark:text-amber-300">(Cash Comm)</span>
                        </div>
                      </th>
                      <th className="px-2.5 py-3.5 text-right whitespace-nowrap w-px bg-purple-50/70 dark:bg-purple-950/40 text-purple-900 dark:text-purple-200 font-mono">
                        <div className="flex flex-col items-end leading-snug">
                          <span>Walletကော်မရှင်</span>
                          <span className="text-[10px] font-normal text-purple-700 dark:text-purple-300">(Wallet Comm)</span>
                        </div>
                      </th>
                      <th className="px-2.5 py-3.5 min-w-[115px]">
                        <div className="flex flex-col break-words leading-snug">
